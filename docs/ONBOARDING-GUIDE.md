...
- Includes current screenshots from the running application, including the current-stock-and-accounting continuity preview on desktop and phone, with paired desktop and phone views for role-specific screens where applicable
